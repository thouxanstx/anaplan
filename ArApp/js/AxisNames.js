...
for(var j = 0;j < 2; j++)
{
  ...
  xAxesNames.push(<ViroText text = {xAxesStrings[j]} width={10} height={100} position={[xAxesPos[0], xAxesPos[1], xAxesPos[2]]} style={styles.axisStyle} />)
...
for(var k = 0;k < 5; k++)
{
  ...
  yAxesNames.push(<ViroText text = {yAxesStrings[k]} width={10} height={100} position={[yAxesPos[0], yAxesPos[1], yAxesPos[2]]} style={styles.axisStyle} />)
...
{
  //Add the Y Axes name to the Y Axes Name Array with the variables set
  yAxesMulNames.push(<ViroText text = {yLeftStrings[ki]} width={10} height={100} position={[yAxesMulPosLeft[0], yAxesMulPosLeft[1], yAxesMulPosLeft[2]]} style={styles.axisStyle} />)
  yAxesMulNames.push(<ViroText text = {yRightStrings[ki]} width={10} height={100} position={[yAxesMulPosRight[0], yAxesMulPosRight[1], yAxesMulPosRight[2]]} style={styles.axisStyle} />)
...
xMulSingleNames.push(<ViroText text = {xMulSingle} width={10} height={100} position={[xAxesSingleNamesPos[0], xAxesSingleNamesPos[1], xAxesSingleNamesPos[2]]} style={styles.axisStyle} />)

//For loop for creating Y Axes names for Column multi series single value
for(var kiii = 0; kiii < 5; kiii++)
{
  //Add the Y Axes name to the Y Axes Name Array with the variables set
  yMulSingleNames.push(<ViroText text = {yMulSingle[kiii]} width={10} height={100} position={[yAxesSingleNamesPos[0], yAxesSingleNamesPos[1], yAxesSingleNamesPos[2]]} style={styles.axisStyle} />)
...
{
  yAxesBarNames.push(<ViroText text = {yAxesBarStrings[bari]} width={10} height={100} position={[yAxesBarPos[0], yAxesBarPos[1], yAxesBarPos[2]]} style={styles.axisStyle} />)
...
{
  //Add the Y Axes name to the Y Axes Name Array with the variables set
  xAxesBarNames.push(<ViroText text = {xAxesBarStrings[barii]} width={10} height={100} position={[xAxesBarPos[0], xAxesBarPos[1], xAxesBarPos[2]]} style={styles.axisStyle} />)
  xAxesBarLines.push(<ViroPolyline position={[0, 0, 0]} 
...
{
  //Add the Y Axes name to the Y Axes Name Array with the variables set
  xAxesBarMulNames.push(<ViroText text = {xtopStrings[barmul]} width={10} height={100} position={[xAxesBarMulPosTop[0], xAxesBarMulPosTop[1], xAxesBarMulPosTop[2]]} style={styleCenter.axisStyle} />)
  xAxesBarMulNames.push(<ViroText text = {xBottomStrings[barmul]} width={10} height={100} position={[xAxesBarPosBottom[0], xAxesBarPosBottom[1], xAxesBarPosBottom[2]]} style={styleCenter.axisStyle} />)
...
{
  //Add the X Axes name to the X Axes Name Array with the variables set
  xAxesAreaMulNames.push(<ViroText text = {xAreaMulStrings[jj]} width={10} height={100} position={[xAxesAreaMulPos[0], xAxesAreaMulPos[1], xAxesAreaMulPos[2]]} style={styles.axisStyle} />)
...
{
  //Add the Y Axes name to the Y Axes Name Array with the variables set
  yAxesAreaMulNames.push(<ViroText text = {yAxesAreaMulStrings[jjj]} width={10} height={100} position={[yAxesAreaMulPos[0], yAxesAreaMulPos[1], yAxesAreaMulPos[2]]} style={styles.axisStyle} />)
